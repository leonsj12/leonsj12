...
<h1 align="center">
  <a href="https://github.com/leonsj12">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=F7A41D&center=true&vCenter=true&width=850&lines=%F0%9F%93%96+Estudiante+de+Python+y+R+con+pas%C3%ADon!;%F0%9F%93%88+Datos%2C+visualizaci%C3%B3n+y+ciencia.;%F0%9F%92%BB+Amante+de+Jupyter%2C+Colab+y+PyCharm.;%E2%9C%85+Aprender+jugando%2C+creando+y+construyendo." alt="Typing SVG" />
  </a>
</h1>

## 👋 ¡Hola! / Hi there!

Soy **León, S.**, estudiante de programación y estadística. Estoy explorando el mundo de los datos usando herramientas increíbles como Python, R, JupyterLab y Google Colab. ¡Cada línea de código es una aventura nueva!

I'm **León, S.**, a programming and data science enthusiast exploring the world through code. I build skills in Python, R, JupyterLab, and Google Colab—turning data into insights and fun!

## 🚀 Aprendiendo / Learning Now

```bash
🧠 Python + lógica + funciones
📈 Visualización con matplotlib y ggplot2
...
|------------|----------------|
| [📘 funciones_python](https://github.com/leonsj12/funciones_python) | Funciones básicas en Python |
